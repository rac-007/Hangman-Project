...
class Hangman:
    ...
    Parameters:
        word_list: List of words, in this code list of fruits.
        num_lives: int
            Number of lives the player has, initialised to 5.
    Attributes:
        word: str
    ...
    def check_guess(self, guess):
        ...
        For-Loop with enumerate:
            Iterates over the word and checks if each letter matches the guessed letter.
            Updates the word_guessed list with the guessed letter in the correct positions.
...
def play_game(word_list):
    '''
    Creating an instance of Hangman game and passing arguments.
    '''
    num_lives = 5
